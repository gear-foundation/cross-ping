...
import { ETHEREUM_HTTPS_RPC_URL, BEACON_API_URL, CHECKPOINT_LIGHT_CLIENT, HISTORICAL_PROXY_ID, PING_RECEIVER_PROGRAM_ID, PING_RECEIVER_SERVICE, PING_RECEIVER_METHOD, } from './config.js';
...
async function main() {
    ...
    listenPingFromEthereum(ethApi, async (_from, event) => {
        ...
        try {
            ...
            if (res.error)
                console.error('⚠️ Proxy error:', res.error);
